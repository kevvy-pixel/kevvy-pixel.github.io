...
export const siteConfig: SiteConfig = {
	...
	// 站点副标题
	subtitle: "Data Science · Intelligent Sensing · Optimization",
	...
	// 站点描述
	description:
		"肖闫可唯的个人科研主页，聚焦数据科学、智能感知、自然语言处理与多目标优化。",

	// 站点关键词
	keywords: ["肖闫可唯", "兰州大学", "数据科学", "智能感知", "自然语言处理", "数学建模"],
	...
	navbar: {
		...
		logo: {
			type: "icon",
			value: "material-symbols:science-outline",
		},
		// 导航栏标题
		title: "肖闫可唯",
		// 全宽导航栏，导航栏是否占满屏幕宽度
