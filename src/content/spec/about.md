...
- **运筹与工程优化**：遗传算法、差分进化、NSGA-II、敏感性分析与多目标决策。
...
- **道路结构沉降监测及塌陷预警研究** · 核心成员：负责 FBG 数据处理、反演算法、运动学约束神经场及 MATLAB 实现；
- **基于 LoRa 调制的通感一体化实验教学系统** · 成员：负责 MATLAB 信号处理仿真、算法参数优化与低成本实验系统软件支持。
...
- GitHub：[kevvy-pixel](https://github.com/kevvy-pixel)
